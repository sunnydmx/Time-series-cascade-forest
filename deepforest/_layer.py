...
def _build_estimator(
    ...
    oob_decision_function += X_aug_train
    ...
    def fit_transform(self, X, y, sample_weight=None):
        ...
        for estimator_idx in range(1):
            X_aug_, _estimator = _build_estimator(
                ...
                estimator_idx,
                "srf",
                self._make_estimator(estimator_idx, "srf"),
                oob_decision_function,
                self.partial_mode,
                self.buffer,
                self.verbose,
            )
            print("shapelet random forest complete")
            # print(type(X_aug_))
            X_aug.append(X_aug_)
            key = "{}-{}-{}".format(self.layer_idx, estimator_idx, "srf")
            self.estimators_.update({key: _estimator})
        ...
        #         estimator_idx,
        #         "pairsrf",
        #         self._make_estimator(estimator_idx, "pairsrf"),
        #         oob_decision_function,
        #         self.partial_mode,
        #         self.buffer,
        #         self.verbose,
        #     )
        #     print("random pairwise shapelets forest complete")
        #     # print(type(X_aug_))
        #     X_aug.append(X_aug_)
        #     key = "{}-{}-{}".format(self.layer_idx, estimator_idx, "pairsrf")
        #     self.estimators_.update({key: _estimator})
